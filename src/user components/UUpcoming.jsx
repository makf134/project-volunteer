...
function UUpcoming(){
    ...
    return (
        ...
        <Typography variant="h3" align="center" className={classes.banner} style={{marginTop:'100px',marginBottom:'100px',fontFamily:['Balsamiq Sans', 'cursive']}}>UPCOMING EVENTS</Typography>
        </ThemeProvider>
