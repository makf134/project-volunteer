...
import UCardEvents from "./UCardEvent";
...
function UFinished(){
    ...
    return (
        ...
        <Typography variant="h3" align="center" className={classes.banner} style={{marginTop:'100px',marginBottom:'100px',fontFamily:['Balsamiq Sans', 'cursive']}}>FINISHED EVENTS</Typography>
        </ThemeProvider>
        <Grid container spacing={5}  style={{marginLeft:'200px',width:'1500px'}}>
                    {cardData.map((curr,index) =>{
                        ...
                        <CircularProgress />
                        :
                        <UCardEvents eventname={data.name.first} description={curr.description} image={curr.img} />
                        }
                        </Grid>);
                    })}
        </Grid>
