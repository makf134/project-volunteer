...
function Finished(){
    ...
    return (
        ...
        <Typography variant="h3" align="center" style={{marginTop:'100px',marginBottom:'100px',fontFamily:['Balsamiq Sans', 'cursive']}}  className={classes.banner}>FINISHED EVENTS</Typography>
        </ThemeProvider>
